...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { chord: @score.chord, key: @score.key, tittle: @score.tittle } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { chord: @score.chord, key: @score.key, tittle: @score.tittle } }
